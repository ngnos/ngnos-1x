...
import ngnos.remote
from ngnos.configsource import ConfigSourceSession, ngNOSError
from ngnos.migrator import Migrator, VirtualMigrator, MigratorError
...
configdir = ngnos.defaults.directories['config']
...
if any(x in file_name for x in protocols):
    config_string = ngnos.remote.get_remote_config(file_name)
