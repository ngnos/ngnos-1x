...
def op(cmd: str) -> str:
    """Returns a command with the ngNOS operational mode wrapper."""
...
def show_version() -> None:
    """Prints the ngNOS version and package changes."""
    execute_command(op('show version'), 'ngNOS Version and Package Changes')
...
def show_user_startup_scripts() -> None:
    ...
    execute_command('cat /config/scripts/ngnos-postconfig-bootup.script', 'User Startup Scripts')
