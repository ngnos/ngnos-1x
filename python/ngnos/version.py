...
"""
ngNOS version data access library.

ngNOS stores its version data, which include the version number and some
...
from ngnos.util import read_json
from ngnos.util import popen
from ngnos.util import run
from ngnos.util import DEVNULL


version_file = os.path.join(ngnos.defaults.directories['data'], 'version.json')
    ...
    [
       {
        ...
        "image":"ngnos-rolling-latest.iso",
        "latest":true,
        "lts":false,
        "release_date":"2022-09-06",
        "release_train":"sagitta",
        "url":"http://xxx/rolling/current/ngnos-rolling-latest.iso",
        "version":"ngnos-1.4-rolling-202209060217"
      }
    ]
    """
    headers = {}
