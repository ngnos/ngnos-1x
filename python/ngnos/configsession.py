# configsession -- the write API for the ngNOS running config
...
MIGRATE_LOAD_CONFIG = ['/usr/libexec/ngnos/ngnos-load-config.py']
...
def inject_ngnos_env(env):
    ...
    env['NGNOS_HEADLESS_CLIENT'] = 'ngnos_http_api'
    ...
    env['ngnos_bin_dir'] = '/usr/bin'
    env['ngnos_cfg_templates'] = '/opt/vyatta/share/vyatta-cfg/templates'
    env['ngnos_completion_dir'] = '/usr/libexec/ngnos/completion'
    env['ngnos_configdir'] = '/opt/vyatta/config'
    env['ngnos_conf_scripts_dir'] = '/usr/libexec/ngnos/conf_mode'
    env['ngnos_datadir'] = '/opt/vyatta/share'
    env['ngnos_datarootdir']= '/opt/vyatta/share'
    env['ngnos_libdir'] = '/opt/vyatta/lib'
    env['ngnos_libexec_dir'] = '/usr/libexec/ngnos'
    env['ngnos_op_scripts_dir'] = '/usr/libexec/ngnos/op_mode'
    env['ngnos_op_templates'] = '/opt/vyatta/share/vyatta-op/templates'
    env['ngnos_prefix'] = '/opt/vyatta'
    env['ngnos_sbin_dir'] = '/usr/sbin'
    env['ngnos_validators_dir'] = '/usr/libexec/ngnos/validators'

    # if running the ngnos-configd daemon, inject the vyshim env var
    if is_systemd_service_running('ngnos-configd.service'):
...
class ConfigSession(object):
    ...
    def __init__(self, session_id, app=APP):
        ...
        session_env = inject_ngnos_env(session_env)
        for k, v in env_list:
            session_env[k] = v
