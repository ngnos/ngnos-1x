# configtree -- a standalone ngNOS config file manipulation library (Python bindings)
...
LIBPATH = '/usr/lib/libngnosconfig.so.0'
...
class ConfigTree(object):
    def __init__(self, config_string=None, address=None, libpath=LIBPATH):
        ...
        self.__migration = os.environ.get('NGNOS_MIGRATION')
    ...
    def set(self, path, value=None, replace=True):
        """Set new entry in ngNOS configuration.
