...
from ngnos.configtree import ConfigTree, ConfigTreeError, show_diff
from ngnos.defaults import directories
from ngnos.util import is_systemd_service_active, ask_yes_no, rc_cmd
...
commit_hooks = {'commit_revision': '01ngnos-commit-revision',
                'commit_archive': '02ngnos-commit-archive'}
...
Proceed ?'''
        ...
        # start notify
        cmd = f'sudo -b /usr/libexec/ngnos/commit-confirm-notify.py {minutes}'
        os.system(cmd)
    ...
    def commit_archive(self):
        ...
        """
        from ngnos.remote import upload
