...
from ngnos.xml import definition
from ngnos.xml import load
from ngnos.xml import kw
...
def load_configuration(cache=[]):
    ...
    try:
        from ngnos.xml.cache import configuration
...
if __name__ == '__main__':
    ...
    print(is_tag(["system", "login", "user", "ngnos", "authentication", "public-keys"]))
