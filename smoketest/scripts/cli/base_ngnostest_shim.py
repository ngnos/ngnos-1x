...
from ngnos.defaults import commit_lock
from ngnos.util import cmd
from ngnos.util import run

save_config = '/tmp/ngnos-smoketest-save'

# This class acts as shim between individual Smoketests developed for ngNOS and
